...
const FEATURE_CARDS$1 = [
  {
    ...
    description: "Maximize GPU utilization and billing efficiency across your entire neocloud infrastructure portfolio.",
    icon: Clock,
    cta: "Learn more",
    href: "#"
  },
  {
    ...
    description: "Isolate customer workloads while optimizing resource allocation and maintaining SLA compliance.",
    icon: Activity,
    cta: "Learn more",
    href: "#"
  },
  {
    ...
    description: "Predictive analytics for demand forecasting, auto-scaling decisions, and hardware procurement timing.",
    icon: Bug,
    cta: "Learn more",
    href: "#"
  },
  {
    ...
    description: "Detailed usage patterns, cost attribution, and performance insights for your enterprise clients.",
    icon: Settings,
    cta: "Learn more",
    href: "#"
  }
];
function NeocloudDashboard() {
  return /* @__PURE__ */ jsxs("section", { className: "section-padding relative container !pt-0", children: [
    /* @__PURE__ */ jsx("div", { className: "mx-auto flex max-w-3xl flex-col items-center text-center", children: /* @__PURE__ */ jsx("h2", { className: "text-4xl leading-none tracking-tight text-balance md:text-5xl lg:text-6xl", children: "Purpose-built neocloud infrastructure management and optimization" }) }),
    /* @__PURE__ */ jsx(
      "img",
      {
        src: "/dashboard.png",
    ...
    /* @__PURE__ */ jsx("h3", { className: "text-muted-foreground mt-4 text-center uppercase", children: "MAXIMIZE UTILIZATION · INCREASE REVENUE · REDUCE OPERATIONAL OVERHEAD" }),
  ...
  return /* @__PURE__ */ jsxs("section", { className: "section-padding relative container overflow-hidden", children: [
    /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-4xl flex-col items-center justify-center gap-5 text-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center rounded-full border p-1 text-xs", children: [
        /* @__PURE__ */ jsx("span", { className: "bg-muted rounded-full px-3 py-1", children: "Industry Focus" }),
        /* @__PURE__ */ jsx("span", { className: "px-3", children: "Neocloud Solutions" })
      ] }),
      /* @__PURE__ */ jsxs("h1", { className: "text-foreground text-5xl leading-none tracking-tight text-balance md:text-6xl lg:text-7xl", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "revenue growth" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-muted-foreground max-w-2xl leading-snug md:text-lg lg:text-xl", children: "LaunchHPC empowers neoclouds like CoreWeave and Lambda Labs to optimize resource utilization, reduce operational costs, and scale AI/HPC workloads intelligently." })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto mt-10 max-w-md space-y-3 md:mt-20", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "text-center text-sm", children: "Powering leading neoclouds · 99.9% uptime SLA" })
    ] })
  ] });
}

function NeocloudLogs() {
...
const $$Neocloud = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "DefaultLayout", $$DefaultLayout, { "title": "LaunchHPC for Neoclouds - AI/HPC Infrastructure Solutions", "description": "Maximize neocloud infrastructure efficiency and revenue growth with LaunchHPC's AI/HPC orchestration platform. Scale compute resources intelligently across hybrid environments." }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "NeocloudHero", NeocloudHero, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/sections/neocloud-hero", "client:component-export": "default" })} ${renderComponent($$result2, "NeocloudDashboard", NeocloudDashboard, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/sections/neocloud-dashboard", "client:component-export": "default" })} ${renderComponent($$result2, "NeocloudFeatures", NeocloudFeatures, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/sections/neocloud-features", "client:component-export": "default" })} ${maybeRenderHead()}<div class="relative"> <div class="to-accent/50 bg-chart-1 absolute top-0 left-0 -z-3 hidden size-40 -translate-x-1/4 -translate-y-1/2 rounded-full will-change-transform lg:block"></div> ${renderComponent($$result2, "NeocloudLogs", NeocloudLogs, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/sections/neocloud-logs", "client:component-export": "default" })} </div> ` })}`;
}, "/Users/broke/Herd/astro/LHPC/site/src/pages/industry/neocloud.astro", void 0);

const $$file = "/Users/broke/Herd/astro/LHPC/site/src/pages/industry/neocloud.astro";
const $$url = "/industry/neocloud";
