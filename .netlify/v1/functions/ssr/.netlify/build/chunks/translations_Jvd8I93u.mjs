import { g as getCollection } from './_astro_content_CbPRZjXr.mjs';
import i18next from 'i18next';
import { j as objectType, k as stringType, a as AstroUserError } from './astro/server_BEbvqcAg.mjs';

const starlightConfig = {"description":"AI/HPC Orchestration Platform Documentation","tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Getting Started","translations":{},"collapsed":false,"autogenerate":{"directory":"docs","attrs":{}}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"LaunchHPC Docs"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///Users/broke/Herd/astro/LHPC/site/","srcDir":"file:///Users/broke/Herd/astro/LHPC/site/src/","trailingSlash":"ignore"};
